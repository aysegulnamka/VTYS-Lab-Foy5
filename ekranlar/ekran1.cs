...
namespace labfoy5.ekranlar
{
    public partial class ekran1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=DESKTOP-ARP8JRE\\SQLEXPRESS;Initial Catalog=Foy5;Trusted_Connection=True;MultipleActiveResultSets=true"))
            {
                con.Open();
                ...
                using (SqlCommand checkStudentCmd = new SqlCommand(checkStudentQuery, con))
                {
                    ...
                    if (studentCount > 0)
                    {
                        MessageBox.Show("Öğrenci zaten var.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=DESKTOP-ARP8JRE\\SQLEXPRESS;Initial Catalog=Foy5;Trusted_Connection=True;MultipleActiveResultSets=true"))
            {
                try
                {
                    ...
                    string query = @"UPDATE dbo.tOgrenci 
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        if (rowsAffected > 0)
                        {
                            MessageBox.Show("Öğrenci güncellendi.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
